...
import (
	...
	"github.com/HCRXchenghong/api-codex/internal/handler"
	adminhandler "github.com/HCRXchenghong/api-codex/internal/handler/admin"
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "FriendGate",
					...
					service.SettingKeySiteName:     "FriendGate",
