...
const DEFAULT_UPDATE_REPOSITORY: &str = "HCRXchenghong/infinite-ai-2.0";
...
async fn manifest_exists(client: &reqwest::Client, manifest_url: &str) -> Result<bool, String> {
    let response = client
        .head(manifest_url)
        .header(USER_AGENT, "Infinite AI-Updater")
        .send()
        .await
...
mod tests {
    ...
    fn feed_entry(tag_name: &str) -> ReleaseFeedEntry {
        ReleaseFeedEntry {
            ...
            title: Some(format!("Infinite AI {tag_name}")),
            html_url: Some(format!(
                "https://github.com/HCRXchenghong/infinite-ai-2.0/releases/tag/{tag_name}"
            )),
...
<feed xmlns="http://www.w3.org/2005/Atom">
  <entry>
    ...
    <link rel="alternate" type="text/html" href="https://github.com/HCRXchenghong/infinite-ai-2.0/releases/tag/v0.1.2"/>
    <title>Infinite AI v0.1.2</title>
  </entry>
</feed>"#,
        )
    ...
    fn prerelease_channel_can_select_prerelease_manifest() {
        ...
        assert_eq!(
            ...
            "https://github.com/HCRXchenghong/infinite-ai-2.0/releases/download/v0.1.2-beta.1/latest.json"
        );
