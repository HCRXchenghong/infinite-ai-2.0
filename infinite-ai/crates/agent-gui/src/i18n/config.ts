...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.exitConfirmTitle": "退出 Infinite AI？",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "关于 Infinite AI",
    ...
    "settings.aboutRestartingDesc": "Infinite AI 正在退出并重新打开。",
    ...
    "settings.shortcutSummonDesc": "从任意位置立即唤起并聚焦 Infinite AI 主窗口",
    ...
    "settings.shortcutPinDesc": "切换主窗口置顶，让 Infinite AI 浮在其他应用上方",
    ...
    "settings.systemToolsBuiltinDesc":
      "Infinite AI 在 Agent 模式下自动注册的内置工具，此处仅供查阅。",
    ...
    "settings.remoteDesc": "通过云端 Gateway 远程控制本地 Infinite AI",
    ...
    "settings.skillsImportDesc":
      "扫描本机 Claude Code、Codex、CodeBuddy 的技能目录，勾选后导入到 Infinite AI。",
  ...
  "en-US": {
    ...
    "chat.exitConfirmTitle": "Exit Infinite AI?",
    ...
    "chat.welcome": "Welcome to Infinite AI",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "About Infinite AI",
    ...
    "settings.aboutInstalledDesc":
      "The update package has been installed. Restart Infinite AI to use it.",
    "settings.aboutRestarting": "Restarting app",
    "settings.aboutRestartingDesc": "Infinite AI is quitting and opening again.",
    ...
    "settings.shortcutSummonDesc":
      "Instantly bring up and focus the Infinite AI window from anywhere",
    ...
    "settings.shortcutPinDesc": "Toggle always-on-top so Infinite AI floats above other apps",
    ...
    "settings.systemToolsBuiltinDesc":
      "Built-in tools that Infinite AI registers automatically in Agent mode. Read-only list; click the eye icon for details.",
    "settings.systemToolsCustomDesc":
    ...
    "settings.remoteDesc": "Control your local Infinite AI remotely via cloud Gateway",
    ...
    "settings.skillsImportDesc":
      "Scan local Claude Code, Codex, and CodeBuddy skill directories, then pick skills to import into Infinite AI.",
