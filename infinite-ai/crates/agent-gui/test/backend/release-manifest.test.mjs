  ...
  try {
    ...
    const result = spawnSync(
      ...
      [manifestScript, dir, outputPath, notesPath],
      {
        ...
        env: {
          ...process.env,
          GITHUB_REPOSITORY: "HCRXchenghong/infinite-ai-2.0",
          RELEASE_TAG: "v9.9.9",
        },
        encoding: "utf8",
      },
    ...
    assert.equal(
      ...
      "https://github.com/HCRXchenghong/infinite-ai-2.0/releases/download/v9.9.9/LiveAgent-v9.9.9-macOS-aarch64.app.tar.gz",
    );
