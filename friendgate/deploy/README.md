# FriendGate Deployment Files

This directory contains files for deploying FriendGate on Linux servers and Apple-silicon Macs.
...
Apple-silicon Macs running macOS 26 can run the complete FriendGate, PostgreSQL, and Redis stack with Apple `container` 1.1.0 or newer:
...
curl -sSL https://raw.githubusercontent.com/HCRXchenghong/api-codex/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/HCRXchenghong/api-codex/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
FriendGate supports three methods to connect to Gemini:
...
```bash
curl -sSL https://raw.githubusercontent.com/HCRXchenghong/api-codex/main/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download the latest release from [GitHub Releases](https://github.com/HCRXchenghong/api-codex/releases)
...
FriendGate supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
