...
const (
	...
	// Gemini CLI OAuth credentials are deployment configuration, never source literals.
...
// These variables remain exported for compatibility. Production deployments
// must set both environment variables; tests may assign safe fixture values.
var (
