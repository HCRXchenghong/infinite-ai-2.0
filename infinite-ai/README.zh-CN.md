...
<p align="center">
  <img src="docs/images/QQ.png" alt="Infinite AI QQ 交流群" width="300" />
</p>

<p align="center">
  欢迎扫码进群，一起推进 Infinite AI 的开发！<br/>
...
Infinite AI 是一个 **本地优先** 的 AI Agent 桌面客户端。它将大语言模型的推理能力与本地系统工具深度整合,让 AI 能够真正操作你的文件系统、执行命令、管理定时任务,同时通过 Gateway 实现远程访问与协作。
...
安装包由 GitHub Actions 自动构建、签名并发布,请前往 [**GitHub Releases**](https://github.com/HCRXchenghong/infinite-ai-2.0/releases/latest) 获取最新版本。
...
从 [Releases](https://github.com/HCRXchenghong/infinite-ai-2.0/releases/latest) 下载对应芯片的 DMG,打开后将 Infinite AI 拖入「应用程序」:

- Apple Silicon(M 系列):`Infinite AI-<版本>-macOS-aarch64.dmg`
- Intel:`Infinite AI-<版本>-macOS-x64.dmg`

> 安装包已签名并通过 Apple 公证,首次启动无需在安全设置中手动放行。

### Windows 用户

从 [Releases](https://github.com/HCRXchenghong/infinite-ai-2.0/releases/latest) 按需选择一种安装方式:

| 方式 | 文件 | 适合 |
|---|---|---|
| 安装向导 | `Infinite AI-<版本>-Windows-x64-Setup.exe` | 大多数用户 |
| MSI 包 | `Infinite AI-<版本>-Windows-x64.msi` | 企业分发 / 静默安装 |
| 便携版 | `Infinite AI-<版本>-Windows-x64-portable.zip` | 免安装,解压即用 |

### Linux 用户

从 [Releases](https://github.com/HCRXchenghong/infinite-ai-2.0/releases/latest) 按发行版选择:
