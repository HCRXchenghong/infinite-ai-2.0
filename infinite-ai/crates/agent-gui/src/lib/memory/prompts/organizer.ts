...
export const ORGANIZER_SYSTEM_PROMPT = `# Infinite AI Memory Organizer

You are running an offline memory organization pass for Infinite AI.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing Infinite AI memories for an offline organization pass.
