...
export function createSubagentTools(params: {
  ...
  const toolAgent: Tool = {
    ...
    description: [
      ...
      "Subagents cannot call Agent recursively. Worktree mode must not modify global Infinite AI settings, MCP server configuration, cron tasks, or user-level skills.",
