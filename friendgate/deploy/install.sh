#!/bin/bash
#
# FriendGate Installation Script
# FriendGate 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/HCRXchenghong/api-codex/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="HCRXchenghong/api-codex"
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="FriendGate 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 FriendGate 服务："
    ...
    ["not_installed"]="FriendGate 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 FriendGate。"
    ...
    ["uninstall_complete"]="FriendGate 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 FriendGate"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 FriendGate"
    ...
    ["server_config_desc"]="配置 FriendGate 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="FriendGate Installation Script"
    ...
    # Completion
    ["install_complete"]="FriendGate installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start FriendGate service:"
    ...
    # Upgrade
    ["upgrading"]="Upgrading FriendGate..."
    ...
    ["not_installed"]="FriendGate is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove FriendGate from your system."
    ...
    ["uninstall_complete"]="FriendGate has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install FriendGate"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove FriendGate"
    ...
    ["server_config_desc"]="Configure FriendGate server listen address"
...
[Unit]
Description=FriendGate - AI API Gateway Platform
Documentation=https://github.com/HCRXchenghong/api-codex
...
# Upgrade function
upgrade() {
    # Check if FriendGate is installed
    if [ ! -f "$INSTALL_DIR/sub2api" ]; then
...
# Requires: FriendGate must already be installed
install_version() {
