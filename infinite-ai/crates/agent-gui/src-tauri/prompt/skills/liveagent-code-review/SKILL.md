...
This is an independent Infinite AI workflow modeled on Anthropic's public Claude Code Code Review plugin. The instructions and implementation are original to Infinite AI and are not affiliated with or endorsed by Anthropic.
